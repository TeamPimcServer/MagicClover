...
public class Config
{
	...
	public static void load()
	{
		...
		chanceToDrop.setComment("Chance to drop clover from grass (10 is vanilla seeds chance).\nCan be set to 0 for no drop.");
