		...
		if (rare.isList())
		{
			...
			for (String s : items)
			{
				if (digitsOnly.matcher(s).matches())
				{
					...
					MagicClover.logger.log(Level.ERROR, String.format("MagicClover: Item ids are not supported (%s).", id));
				} else
				{
